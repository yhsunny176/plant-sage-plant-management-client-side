                                            ...
                                            <div className="mt-auto space-y-3 md:space-y-4">
                                                ...
                                                <div className="grid grid-cols-2 gap-4 text-base border-y border-input-border py-3">
                                                    <div className="flex flex-col gap-1">
                                                        ...
                                                        <span
                                                            className={`inline-flex items-center px-4 py-2 mt-2 rounded text-base font-bold border capitalize ${getCareLevelColor(
                                                                plant.careLevel
                                                            )} w-fit`}>
                                                            {plant.careLevel}
                                                        </span>
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        ...
                                                        <span
                                                            className={`inline-flex items-center px-4 py-2 mt-2 rounded text-base font-bold border capitalize ${getHealthStatusColor(
                                                                plant.healthStatus
                                                            )} w-fit`}>
                                                            {plant.healthStatus}
                                                        </span>
                                                    ...
                                                    <div className="col-span-2 flex items-center gap-2">
                                                        ...
                                                        <span className="text-black-pg-light text-base">
