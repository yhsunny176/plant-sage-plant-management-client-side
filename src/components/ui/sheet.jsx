    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        <SheetPrimitive.Close
          className="cursor-pointer data-[state=open]:bg-transparent text-btn-background-static absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:outline-hidden disabled:pointer-events-none">
